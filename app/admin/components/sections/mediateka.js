...
function Mediateka(props) {
  ...
  const handleFileChange = async (e) => {
    ...
    try {
      const res = await axios.post(`${server_config.api_host}/upload/${server_config.site_key}/${e.target.name}`, formData, {
        ...
        case 'icons':
            props.setAllIcons((prev) => [
                ...prev,
                {
                    ...
                    src: `${server_config.api_host}/uploads/${server_config.site_key}/${e.target.name}/${res.data.filename}`,
                },
            ]);
            break;
        case 'slider':
