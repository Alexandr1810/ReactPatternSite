...
function Form ({
    ...
    }, [utm_source, utm_medium, utm_campaign, activeCity, formName, offer]);
    ...
    return(
        ...
        <form className='dealForm' onSubmit={(e)=>{
            ...
            <label className='politicBlock'>
                ...
                <span className='politicText'>Я подтверждаю ознакомление с <a href={`${server_config.api_host}/uploads/${server_config.site_key}/politics/politika.pdf`} target="_blank" >Политикой обработки персональных данных</a> и даю <a href={`${server_config.api_host}/uploads/${server_config.site_key}/politics/sogl.pdf`} target="_blank" >Согласие на обработку моих персональных данных.</a></span>
            </label>
