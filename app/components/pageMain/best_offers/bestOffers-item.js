...
function TarifPreview(props){
    ...
    return(
    <div className={`bestOffers-block ${inView ? 'visible' : ''}`} ref={ref}>
        ...
        <span className='bestOffers-block-title'>{props.plan.name}</span>
        <div className='bestOffers-block-inner'>
                ...
                <div className='elem'>
                    ...
                    <div className='right-side'>
                        <label className="checkbox-ios" htmlFor={`needRouter_${props.plan.id}_${uid}`}>
                            <input type="checkbox" aria-label="Нужен роутер" id={`needRouter_${props.plan.id}_${uid}`} checked={props.plan.needRouter} onChange={(event)=>{
                                props.toggleFieldById(props.plan.id, 'needRouter', event.target)
                            }}/>
        ...
        <div className='bestOffers-block-buttons'>
